      ...
      <div class="flex">
        ...
        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
          ...
          @can('admin')
            ...
            <x-nav-link :href="route('positions')" :active="request()->routeIs('positions')" wire:navigate>
              {{ __('Positions') }}
            </x-nav-link>
          ...
          <x-dropdown align="right" width="48">
            <x-slot name="trigger">
              <button
                ...
                <i class="fa-solid fa-gear fa-lg relative"></i>
              </button>
            </x-slot>
  ...
  <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
    <div class="pt-2 pb-3 space-y-1">
      ...
      @can('admin')
        ...
        <x-responsive-nav-link :href="route('departments')" :active="request()->routeIs('departments')" wire:navigate>
          {{ __('Departments') }}
        </x-responsive-nav-link>
        <x-responsive-nav-link :href="route('positions')" :active="request()->routeIs('positions')" wire:navigate>
          {{ __('Positions') }}
        </x-responsive-nav-link>
    ...
    <div class="pt-4 pb-1 border-t border-gray-200">
      ...
      <div class="mt-3 space-y-1">
        <livewire:notifications-responsive-nav-link />

        <livewire:chats-responsive-nav-link />
