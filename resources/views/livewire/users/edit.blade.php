<x-modal name="edit-user" maxWidth="sm">
  @if ($user)
    <div class="p-5">
      <form wire:submit="update">
        ...
        <div class="mb-3">
          ...
          <x-select wire:model="department_id" id="department_id" class="mb-1 w-full"
        ...
        <div class="mb-3">
          ...
          @if (gettype($avatar) == 'string')
            <img src="{{ asset('storage/users-avatar/' . $avatar) }}" alt="User Avatar" class="mb-1 w-full">
          @else
            <img src="{{ $avatar->temporaryUrl() }}" alt="User Avatar" class="mb-1 w-1/2">
          @endif
        ...
        <div class="mb-3">
          ...
          <x-text-input type="password" wire:model="password_confirmation" id="password_confirmation"
            class="mb-1 w-full" placeholder="Password Confirmation..." />
        ...
        <div class="flex justify-end items-center gap-x-2">
          ...
          <x-secondary-button wire:click="$dispatch('close-modal', 'edit-user')"><i
