<x-modal name="edit-position" maxWidth="sm">
  @if ($position)
    <div class="p-5">
      <form wire:submit="update">
        <div class="mb-3">
          <h2 class="text-xl font-semibold">Edit Position</h2>
        </div>
        <div class="mb-3">
        ...
        <div class="flex justify-end items-center gap-x-2">
          ...
          <x-secondary-button wire:click="$dispatch('close-modal', 'edit-position')"><i
