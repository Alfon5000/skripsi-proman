<x-modal name="create-project" maxWidth="sm">
  <div class="p-5">
    <form wire:submit="store">
      ...
      @can('admin')
        <div class="mb-3">
          ...
          <x-select wire:model="manager_id" placeholder="Choose Manager..." class="mb-1 w-full" id="manager_id">
            @foreach (\App\Models\User::roleId(2)->orderBy('name')->get() as $manager)
      ...
      <div class="flex justify-end items-center gap-x-2">
        ...
        <x-secondary-button wire:click="$dispatch('close-modal', 'create-project')"><i
