<div class="overflow-auto">
  ...
  <div class="mb-5 flex justify-between">
    <x-primary-button wire:click="$dispatch('open-modal', 'create-department')"><i
        class="fa-solid fa-plus-square"></i><span class="hidden sm:inline sm:ms-2">Create</span></x-primary-button>
          ...
          @foreach ($departments as $department)
            <tr wire:key="{{ $department->id }}">
              ...
              <td class="border p-2 flex justify-center items-center gap-x-1">
                <x-primary-button wire:click="$dispatch('open-edit', { department: {{ $department }} })"><i
                    class="fa-solid fa-pen-to-square"></i><span
                    class="hidden sm:inline sm:ms-2">Edit</span></x-primary-button>
                <x-danger-button wire:click="$dispatch('open-delete', { department: {{ $department }} })"><i
